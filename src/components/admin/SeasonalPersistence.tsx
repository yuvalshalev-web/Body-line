...
const SeasonalPersistence: React.FC = () => {
  ...
  return (
    <div className="admin-info-card p-8 rounded-[3rem] shadow-soft space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          ...
          <div className="relative h-full admin-info-card p-6 rounded-[2rem] flex flex-col">
            ...
            <div className="space-y-4 flex-grow">
              {leaderboards.penguins.map((m, i) => (
                <div key={m.id} className="flex items-center justify-between p-3 admin-info-card rounded-xl hover:bg-white/60 transition-colors">
                  <div className="flex items-center gap-3">
        ...
        >
          ...
          <div className="relative h-full admin-info-card p-6 rounded-[2rem] flex flex-col bg-gradient-to-b from-cyan-900/5 to-blue-900/5">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
        ...
        >
          ...
          <div className="relative h-full admin-info-card p-6 rounded-[2rem] flex flex-col bg-gradient-to-b from-yellow-400/5 to-amber-600/5">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
