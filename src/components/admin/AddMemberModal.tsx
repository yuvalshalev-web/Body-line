                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          >
                            <span className="text-[#000000] text-right flex-1">{newMemberData.role === 'Admin' ? 'רכז' : newMemberData.role === 'Staff' ? 'צוות עמותה' : newMemberData.role === 'Support' ? 'אפ-שייפר' : newMemberData.role === 'Instructor' ? 'מדריך' : newMemberData.role === 'Volunteer' ? 'מתנדב' : 'משתתף'}</span>
