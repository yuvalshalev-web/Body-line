...
const AdminHelpPage = () => {
  return (
    <div className="luxury-slab p-10 rounded-[30px] text-white font-sans">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* כרטיסייה 1: השעיה */}
        <div className="luxury-card p-8 rounded-3xl transition-transform hover:-translate-y-1">
      ...
      <div className="mt-10 p-5 luxury-card border-r-4 border-[#ff009f] rounded-xl text-center text-[#4a002e] font-bold">
