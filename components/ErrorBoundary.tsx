    ...
    if (this.state.hasError) {
      return this.props.fallback || (
        <div className="p-8 text-center flex flex-col items-center justify-center min-h-[40vh]">
          ...
          <h2 className="text-2xl font-black text-slate-800 mb-2">אופס! משהו השתבש.</h2>
          <p className="text-slate-500 font-bold max-w-md">נתקלנו בשגיאה לא צפויה. המידע הטכני נשמר בחדר המכונות לטיפול הרכזים.</p>
