          ...
          <div className="glass-panel w-full max-w-2xl rounded-[3.5rem] p-12 relative max-h-[90vh] overflow-y-auto">
            ...
            {showSuccess ? (
              ...
              <form onSubmit={handlePostSubmit} className="space-y-6">
                ...
                <div onClick={() => fileInputRef.current?.click()} className="w-full aspect-video bg-[var(--surfer-aqua-mist)]/10 backdrop-blur-[20px] rounded-2xl border-2 border-dashed border-white/30 flex items-center justify-center cursor-pointer overflow-hidden hover:bg-white/5 transition-colors">
