...
- **מרכז ניהול (Admin Center):**
  - ניהול משתמשים: שינוי תפקידים, איפוס סיסמאות וניהול סטטוס.
  - ניהול בקשות הצטרפות: מערכת אישור ודחייה של חברים חדשים.
  - ניהול אירועים: הוספה ומחיקה של אירועי קהילה.
  - גלריית תמונות: ניהול ומחיקת תמונות מהגלריה המשותפת.
  - פודקאסטים: תשתית לניהול פרקי פודקאסט קהילתיים (בקרוב).
  - נכסי אתר: צפייה וניהול של נכסים ויזואליים והגדרות מערכת.
